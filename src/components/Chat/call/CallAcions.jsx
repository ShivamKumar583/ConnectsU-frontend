...
export default function CallAcions({ endCall ,setShowActions}) {
  return (
    <div className="h-22 w-full absolute bottom-0 z-40 px-1">
      {/*Container*/}
      <div className="relative bg-slate-400 px-4 pt-6 pb-12 rounded-xl">
        {/*Expand icon*/}
        <button onClick={() => setShowActions(false)} className="-rotate-90 scale-y-[300%] absolute top-1 left-1/2">
          <ArrowIcon className="fill-slate-600" />
        </button>
        {/*Actions*/}
